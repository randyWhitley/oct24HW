...
const questions = [
  ...
  },
  {
    ...
    answers: [
      "fembot", "manbot", "Borat", "Harley Quinn"
    ],
    correct: "fembot"
  },
  {
...
function startGame() {
  ...
  // questionContainerElement.classList("question-container");
  // setNextQuestion()
}

// records answers in the console, brings user to next question. wrong anwsers will subtract time.
